...
const renderError = (error: unknown): { message: string } => {
  return {
    message: error instanceof Error ? error.message : "Hubo un error",
  };
};
...
export const updateProductImageAction = async (
  ...
  try {
    ...
    revalidatePath(`/admin/products/${productId}/edit`);
    return { message: "Imagen de producto actualizada correctamente" };
  } catch (error) {
    return renderError(error);
  }
};
...
export const toggleFavoriteAction = async (prevState: {
  ...
  try {
    ...
    return {
      message: favoriteId ? "Eliminado de favoritos" : "Añadido a favoritos",
    };
  } catch (error) {
    return renderError(error);
  }
...
export const createReviewAction = async (
  ...
  try {
    ...
    return { message: "Reseña enviada correctamente" };
  } catch (error) {
    return renderError(error);
  }
};
